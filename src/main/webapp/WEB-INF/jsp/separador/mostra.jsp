...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Vededor</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="listaVededores">Vededor</a></li>
	...
	<h3>Alterar Separador - ${separador.id}</h3>
	<form action="alteraVededor" method="post">

		<input type="hidden" name="id" value="${separador.id}" /> <br/>
		Nome:<br />
