...
<body>
  ...
  <div class="container-fluid">
	...
	<div class="container">
		...
		<h3>Alterar Separação - ${pedido.id}</h3>
		<form action="alteraPedido" method="post">
	
			<input type="hidden" name="id" value="${pedido.id}" /> <br />
			Numero do Pedido:<br />
	    	<form:input path="pedido.numped" /><br />
			Descrição:<br />
	    	<form:input path="pedido.descricao" /><br />
	    	
			<br>Separador: <br />
			<form:select path="pedido.separador" itemValue="id" itemLabel="nome" items="${separadores}" /> </br>
				
			<br>Vendedor: <br />
			<form:select path="pedido.vendedor" itemValue="id" itemLabel="nome" items="${vendedores}" /> </br>
