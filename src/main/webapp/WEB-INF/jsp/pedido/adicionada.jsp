...
<html>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="listaPedidos">Separador</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="dropdown">
          <a href="listaPedidos" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Menu <span class="caret"></span></a>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="listaPedidos">Link</a></li>
        <li class="dropdown">
    ...
    Nova pedido adicionada com sucesso!
    <a href="listaPedidos">Lista pedidos</a>
    <meta http-equiv="refresh" content="3;"springweb/listaPedidos"">
